...
class HistogramLayerUNET(nn.Module):
    def __init__(self,in_channels,kernel_size,dim=2,num_bins=4,
                 stride=None,padding=0,normalize_count=True,normalize_bins = True,
                 count_include_pad=False,
                 ceil_mode=False,skip_connection=False):
    ...
    def forward(self,xx):
        ...
        #If skip connection, do not aggregate count (aggregated in UpHist function
        # to adjust size of pooling operation based on size needed)
